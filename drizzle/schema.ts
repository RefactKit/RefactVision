import { pgTable, index, foreignKey, text, timestamp, boolean, integer, bigint, unique, uniqueIndex } from "drizzle-orm/pg-core"
...
export const galleryImage = pgTable("gallery_image", {
	...
	index("gallery_image_organizationId_idx").using("btree", table.organizationId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const notification = pgTable("notification", {
	...
	index("notification_recipientId_idx").using("btree", table.recipientId.asc().nullsLast().op("text_ops")),
	index("notification_recipientId_read_idx").using("btree", table.recipientId.asc().nullsLast().op("text_ops"), table.read.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const organizationRole = pgTable("organization_role", {
	...
	index("organization_role_organizationId_idx").using("btree", table.organizationId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.organizationId],
			foreignColumns: [organization.id],
...
export const project = pgTable("project", {
	...
	index("project_organizationId_idx").using("btree", table.organizationId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.organizationId],
			foreignColumns: [organization.id],
...
export const projectCategory = pgTable("project_category", {
	...
	index("project_category_projectId_idx").using("btree", table.projectId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const projectFile = pgTable("project_file", {
	...
	index("project_file_categoryId_idx").using("btree", table.categoryId.asc().nullsLast().op("text_ops")),
	index("project_file_projectId_idx").using("btree", table.projectId.asc().nullsLast().op("text_ops")),
	foreignKey({
